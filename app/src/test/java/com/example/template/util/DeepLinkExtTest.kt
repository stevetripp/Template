...
class DeepLinkExtTest {
    ...
    fun testToRoute() {
        ...
        assertThat(route1.optParam1).isEqualTo(Parameter("query1"))
        ...
        assertThat(route3.optParam1).isEqualTo(Parameter("query3"))
        ...
        assertThat(route5.optParam1).isEqualTo(Parameter("query5"))
