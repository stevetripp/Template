...
import org.lds.mobile.navigation3.getParameters
...
class UrlExtTest {
    ...
    fun testDeepLinkUrl() {
        ...
        val deepLink1 = Url("https://example.com/users")
        ...
        val deepLink2 = Url("https://example.com/users/123")
        ...
        val deepLink3 = Url("https://example.com/users/123/posts/456")
        ...
        val deepLink7 = Url("https://example.com/users/456/posts/789?sort=desc&filter=recent")
    ...
    fun testGetParameters() {
        ...
        val deepLink3 = Url("https://example.com/users/123?role=admin")
        ...
        val deepLink4 = Url("https://example.com/users/456/posts/789?sort=desc&filter=recent")
        ...
        val deepLink6 = Url("https://example.com/search/hello%20world?lang=en&limit=10")
        ...
        val deepLink7 = Url("https://example.com/users/123")
        ...
        val deepLink8 = Url("https://example.com/users?role=admin&status=active&verified=true")
    ...
    fun testToRoute() {
        ...
        val deepLink1 = Url("${DeepLink.ROOT}/DESTINATION/value1/ONE?queryParam1=query1&queryParam2=TWO")
        ...
        val deepLink2 = Url("${DeepLink.ROOT}/DESTINATION/value2/THREE")
        ...
        val deepLink3 = Url("${DeepLink.ROOT}/DESTINATION/value3/TWO?queryParam1=query3")
        ...
        val deepLink4 = Url("${DeepLink.ROOT}/DESTINATION/test%20value/ONE")
        ...
        val deepLink5 = Url("${DeepLink.ROOT}/DESTINATION/value5/ONE?queryParam1=query5&queryParam3=42")
