 ...
 *
 * See https://cs.android.com/androidx/platform/frameworks/support/+/androidx-main:compose/foundation/foundation/integration-tests/foundation-demos/src/main/java/androidx/compose/foundation/demos/LazyColumnDragAndDropDemo.kt
 *
...
class DragDropState
internal constructor(private val state: LazyListState, private val scope: CoroutineScope, private val onMove: (Int, Int) -> Unit) {
    ...
    internal fun onDragInterrupted() {
        if (draggingItemIndex != null) {
            ...
            scope.launch {
                ...
                previousItemOffset.animateTo(0f, spring(stiffness = Spring.StiffnessMediumLow, visibilityThreshold = 1f))
...
fun LazyItemScope.DraggableItem(
    ...
    Column(modifier = draggingModifier) { content(dragging) }
}