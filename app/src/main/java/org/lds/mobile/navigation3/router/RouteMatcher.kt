package org.lds.mobile.navigation3.router

import androidx.navigation3.runtime.NavKey
import io.ktor.http.decodeURLQueryComponent
import io.ktor.http.encodeURLQueryComponent
import org.ics.mobile.commons.Uri
import org.lds.mobile.navigation3.router.RouteMatcher.Companion.DEFAULT_STRING_LIST_DELIMITER
 ...
 *
 * All matchers are registered in [DeepLinkRouter], which iterates through them to
...
abstract class RouteMatcher<T : NavKey>(
     ...
     *
     * Used by [DeepLinkRouter.toUri] to find the correct matcher for serialization.
     *
